...
Portable database policy and evidence records, local connection boundaries, and Project-format migrations follow [Persistence and Schemas](persistence-and-schemas.md); concrete schemas and connection mapping remain implementation work. Execution-runtime ownership and the internal interface follow [DeepSeek Harness Boundary](deepseek-harness-boundary.md).
